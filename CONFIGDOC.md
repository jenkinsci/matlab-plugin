...
By default, the **Run MATLAB Build**, **Run MATLAB Tests**, and **Run MATLAB Command** steps enable you to access the results of running a MATLAB build and running MATLAB and Simulink tests directly from your Jenkins interface. To disable a step from generating a summary for display on the Jenkins build summary page, clear the **Generate summary** option in the step configuration interface. For more information about build and test summaries, see [View MATLAB Build and Test Results](#view-matlab-build-and-test-results).
